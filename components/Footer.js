...
const Footer = () => {
    return (
        <footer className="text-gray-600 body-font shadow-sm">
        <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
            <Link href={"/"}  className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
            <Image src='/logo.png'  alt='' height={40} width={200}/>
            </Link>
            <p className="mt-2 text-sm text-gray-500 mx-1">wear the &lt;code/&gt; - Premium tshirt,hoodies,mugs and caps.</p>
          </div>
          <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
            <div className="lg:w-1/4 md:w-1/2 w-full px-3">
              ...
              <nav className="list-none mb-10">
                <li>
                  <a href='/tshirts' className="text-gray-600 hover:text-gray-800">Tshirt</a>
                </li>
                <li>
                ...
                <li>
                  <a href='/caps' className="text-gray-600 hover:text-gray-800">Caps</a>
                </li>
              </nav>
            </div>
            <div className="lg:w-1/4 md:w-1/2 w-full px-3">
