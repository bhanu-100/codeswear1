...
<Head>
  ...
  {user.value? <h1 className="text-3xl dark:text- lg:text-4xl font-semibold leading-7 lg:leading-9 text-gray-800">{decoded.name}</h1>:<h1 className="text-3xl dark:text- lg:text-4xl font-semibold leading-7 lg:leading-9 text-gray-800">Name</h1>}
