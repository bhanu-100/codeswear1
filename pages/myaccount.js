    ...
    <div className='min-h-screen mt-20'>
     <ToastContainer
      ...
      <div className='container m-auto '>           
            <h2 className='font-bold my-8'>1.Update Delivery Details</h2>
            ...
            <div>
        <button onClick={updateUser} className="flex w-1/6 justify-center rounded-md bg-pink-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-pink-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pink-600">Update Details</button>
            </div>
            <h2 className='font-bold my-8'>2.Change Password</h2>
            <div className='mx-auto flex'>
